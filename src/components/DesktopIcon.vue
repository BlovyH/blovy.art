...
.desktop-icon.is-dragging .desktop-icon__content {
  ...
  /* Non-uniform scale(sx,sy) turns a circular radius into an ellipse arc
     (horizontal radius ×sx, vertical ×sy). Pre-dividing each axis cancels
     the transform so the rendered corner stays a true 8px circle. */
  border-radius: calc(8px / var(--ft-sx, 1)) / calc(8px / var(--ft-sy, 1));
}
